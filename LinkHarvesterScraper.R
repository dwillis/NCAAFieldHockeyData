...
urls <- read_csv("url_csvs/NCAA Field Hockey - 2022.csv") %>% pull(1) # change this to the year you need
...
urlfilename <- paste0("url_csvs/ncaa_womens_field_hockey_teamurls_", season, ".csv")
